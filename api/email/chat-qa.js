// ABBI Chat Q&A - v9.8.2 restored from 1/24 working version with tool calling
const ANTHROPIC_API_KEY = process.env.ANTHROPIC_API_KEY;
const M365_GATEWAY = 'https://m365-mcp-west.nicecliff-a1c1a3b6.westus2.azurecontainerapps.io/mcp';

// Vercel Pro limit - using Haiku for speed
export const config = {
  maxDuration: 60,
};
...
async function mcpCall(tool, args = {}) {
  ...
  const timeoutId = setTimeout(() => controller.abort(), 15000); // 15 second timeout for tool calls
