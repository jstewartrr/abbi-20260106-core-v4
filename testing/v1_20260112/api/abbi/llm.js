// Custom LLM endpoint for ABBI with full SM Gateway + Hive Mind access
// This endpoint receives requests from ElevenLabs and routes to Claude with MCP tools

const GATEWAY_URL = 'https://cv-sm-gateway-v3.lemoncoast-87756bcf.eastus.azurecontainerapps.io/mcp';

// Use environment variable for fast access (already set in Vercel)
const ANTHROPIC_API_KEY = process.env.ANTHROPIC_API_KEY || '';

// MCP tools available through SM Gateway - Essential tools only for speed
const MCP_TOOLS = [
  {
    name: 'sm_hive_mind_read',
...
// Call MCP tool through SM Gateway
